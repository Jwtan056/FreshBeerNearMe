...
<html lang="en">
    ...
    <body>
        ...
        <?php
            ...
            echo '<input type="submit" name="DeleteAVenue" id="submit-button" style="visibility: hidden;"/>';
            ?></form>
            <form action="EditAVenue.php" method="POST">
            <input id="name" name="_id" type="hidden" value="<?php echo $VenueInfo['_id']; ?>"><?php
            echo '<tr><td><input type="submit" name="ViewAVenue" id="submit-button" value="Edit"/></td></tr>';
            ?></form><?php
        }?> 
        </table>
    </body>
